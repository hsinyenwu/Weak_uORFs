...
```
**Note 1: u-m Ribo ratio is later named as Relative uORF Strength (RuS)**  
**Note 2: The multcompLetters in the manuscript were added to the figures using Adobe illustrator**
